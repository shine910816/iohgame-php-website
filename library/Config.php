...
class Config
{
    ...
    public static function getAllowedCurrent()
    {
        ...
        $result["community"]["custom"] = SYSTEM_AUTH_COMMON;
        ...
        $result["wow_secret"]["recom_condition"] = SYSTEM_AUTH_COMMON;
        $result["wow_secret"]["recom_result"] = SYSTEM_AUTH_COMMON;
        ...
        $result["nba"]["top"] = SYSTEM_AUTH_COMMON;
        $result["nba"]["standings"] = SYSTEM_AUTH_COMMON;
        $result["nba"]["league_leader"] = SYSTEM_AUTH_COMMON;
        ...
        $result["nba"]["chart"] = SYSTEM_AUTH_COMMON;
        ...
        $result["usr_api"]["friend_list"] = SYSTEM_AUTH_COMMON;
        ...
        $result["nba"]["team_leader"] = SYSTEM_AUTH_COMMON;
        $result["nba"]["game_detail"] = SYSTEM_AUTH_COMMON;
