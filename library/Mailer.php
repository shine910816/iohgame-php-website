<?php
require_once SRC_PATH . "/driver/PHPMailer/src/PHPMailer.php";
require_once SRC_PATH . "/driver/PHPMailer/src/SMTP.php";

class Mailer
{
    public static $HOST = 'smtp.mxhichina.com'; // 邮箱的服务器地址
