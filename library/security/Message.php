<?php
require_once SRC_PATH . '/driver/aliyun-dysms-php-sdk/api_sdk/vendor/autoload.php';
...
class Message
{
    ...
    public static function getAcsClient()
    {
        ...
        $accessKeyId = ALIYUN_ACCESS_KEY; // AccessKeyId
     ...
     * @return stdClass
     */
    public static function sendSms($number, $code, $template)
    {
